...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32F429I_DISC1 -DSTM32 -DSTM32F429ZITx -DSTM32F4 -DSTM32F429xx -c -I../Inc -I"D:/Courses/Fastbit/Embedded-C/my_workspace/USB_Guide/USB_Device/Inc/Helpers" -I"D:/Courses/Fastbit/Embedded-C/my_workspace/USB_Guide/USB_Device/Inc/CMSIS/Include" -I"D:/Courses/Fastbit/Embedded-C/my_workspace/USB_Guide/USB_Device/Inc/CMSIS/Device/ST/STM32F4xx/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
